  ...
  <div class="body-warp" id="body-warp">
    ...
    <div class="img-list" v-if="showList">
      <ul class="image-box" v-for="(itme, index) in videoListLop" :key="index">
        <li class="big-img" @click="DownloadApp(itme.big, itme.big.userName, 'woman', itme.big.fabulous)">
          <ins class="online"></ins>
        ...
        <li class="small-img">
          <span @click="DownloadApp(itme.small1, itme.small1.userName, 'woman', itme.small1.fabulous)">
            <ins class="online"></ins>
          ...
          <span @click="DownloadApp(itme.small2, itme.small2.userName, 'woman', itme.small2.fabulous)">
            <ins class="online"></ins>
    ...
    DownloadApp (data) {
      ...
      logReport({
        ...
        free_name2: Object.assign({
          from: 'gomeet-luckycrush'
        }, window.$mObj.adData || {}),
      });
      window.$mObj.adData.lpName = 'gomeet-luckycrush';
      localStorage.setItem('lpName', 'gomeet-luckycrush');
...
.img-list {
  ...
  .online {
    ...
    width: 55px;
    height: 21px;
    background: url(~@/assets/img/h5download/online1.png) no-repeat;
    ...
    &::before{
      ...
      width: 10px;
      height: 10px;
      background: linear-gradient(141deg, #70D6F6 0%, #10FF5C 100%);
      ...
      margin-top: -6px;
      left: 5px;
      animation: bingbing 2s ease-in 1s infinite;
    }
  }
}
