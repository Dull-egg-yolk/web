...
<template>
  <div class="page-body">
    <div class="home-page">
      ...
      <div class="page-top">
        <h2>اهلا وسهلا بك في GoMeet video chat</h2>
        <div>
          <p><span style="color:#2776FF">النساء</span> بشكل عشوائي مع<span style="color:#FF2E93">الرجال</span><span>يتم إقران</span>.</p>
            <p><span style="color:#FF2E93">الرجال</span> بشكل عشوائي مع <span style="color:#2776FF">النساء</span><span>يتم إقران</span>.</p>
        </div>
        <h2>اضغط لبدء الشات الأن</h2>
        <div class="title">١ مليون عضو من اكثر من ١٠٠ بلد </div>
      </div>
      <div class="button">
        <div class="play" @click="goToPlay">ابد محادثة الان </div>
      </div>
      <div class="chatvideo">
        <span></span>
        يطلب منك الإذن لفتح الكاميرا
      </div>
    </div>
...
export default {
    ...
    goToPlay () {
      logReport({
        ...
        free_name2: Object.assign({
          from: 'gomeet-female-video'
        }, window.$mObj.adData || {}),
      });
      window.$mObj.adData.lpName = 'gomeet-female-video';
      localStorage.setItem('lpName', 'gomeet-female-video');
  ...
  mounted () {
    getCountry('gomeet-female-video');
  }
};
</script>
