  ...
  <div class="pop-setting">
    <div class="pop-content">
        ...
        <ul class="common-list">
          ...
          <li class="line" v-if="isMobile"></li>
          <li class="ocell fx-v" @click.stop="showBlockList">{{$t('base.blacklist')}}</li>
          <li class="line" v-if="isMobile"></li>
          <!-- <li class="ocell fx-v" @click.stop="delAccount">{{$t('app.delete_account')}}</li> -->
          <!-- <li class="ocell fx-v" @click.stop="download">{{$t('webChat.downloadApp')}}</li> -->
          <!-- <li class="ocell fx-v" @click.stop="about">{{$t('base.about')}}</li> -->
          <li class="ocell fx-v logout" @click.stop="logout" v-if="isMobile">{{$t('base.logout')}}</li>
        </ul>
    </div>
  </div>
</template>
